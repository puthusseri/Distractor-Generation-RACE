...
class Trainer(object):
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            # Compute loss.
            batch_stats, b_4 = self.valid_loss.monolithic_compute_loss(
                batch, outputs, attns)
        ...
        self.model.train()
        logger.info("{:d} Validation BLEU-4: {:.3f}".format(self.optim._step, (sum(bleu_4) / len(bleu_4))))
        return stats
    ...
    def _forward_prop(self, batch):
        ...
        adj, adj_lengths, _ = batch.adj
        adj_lengths = adj_lengths.type(torch.int32)
